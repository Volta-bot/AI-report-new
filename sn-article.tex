...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{Figure/collaborative_training_process.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{Figure/metr-la-fl_convergence_rounds.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{Figure/pems-bay-fl_convergence_rounds.png}
